...
namespace YelpAPI
{
    ...
    class YelpAPIClient
    {
        ...
        /// </summary>
        private const string CONSUMER_KEY = "Y3W9OzlL-3CvpHvbnnJVOg";

        /// <summary>
        /// Consumer secret used for OAuth authentication.
        /// This must be set by the user.
        /// </summary>
        private const string CONSUMER_SECRET = "efnxltf7f2qewUEaHkgXoQlk6G4";

        /// <summary>
        /// Token used for OAuth authentication.
        /// This must be set by the user.
        /// </summary>
        private const string TOKEN = "v9MJBBDXXhCQHR8HOsOBayCYo8NElPXh";

        /// <summary>
        /// Token secret used for OAuth authentication.
        /// This must be set by the user.
        /// </summary>
        private const string TOKEN_SECRET = "07zctquM3wKxfupLPTK5SobRZbE";
    ...
    class Options
    {
        ...
        [Option('l', "location", DefaultValue="Grand Rapids, MI", HelpText = "Search Location")]
